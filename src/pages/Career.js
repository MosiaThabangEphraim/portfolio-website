  ...
  return (
    <div className="career-container">
      ...
      <div className="career-stage">
        <div className="career-stage-title"> Foundations and Learning (Current Stage) </div>
      ...
      <div className="career-stage">
        <div className="career-stage-title"> Practical Experience and Projects (Short-Term Goal) </div>
        <ul className="career-list">
          <li> Developing real-world applications like task management apps, personal websites, and productivity tools. </li>
          <li>
            {' '}
            Gaining experience with databases, local storage, and basic cloud
            integration.{' '}
          </li>{' '}
          <li> Exploring front-end frameworks (React, XAML) and back-end development (.NET, ASP.NET). </li>
        </ul>{' '}
      </div>{' '}
      <div className="career-stage">
        <div className="career-stage-title"> Advanced Skills and Specialization (Mid-Term Goal) </div>
        <ul className="career-list">
          <li> Diving into full-stack development to create scalable applications. </li>
          <li>
            {' '}
      ...
      <div className="career-stage">
        <div className="career-stage-title"> Professional Growth and Career Development (Long-Term Goal) </div>
        <ul className="career-list">
          <li>
            {' '}
